...
import { ParsedMail, EmailAddress, Attachment, Headers, HeaderLines } from 'mailparser'
 ...
 * @return {Promise<File>}
 */
export function storeAttachment(attachment: AttachmentFile, bucket: Bucket): Promise<File>;
